...
const Article = ({id, poster, title, comments}) => {
    return (
        <Link className='article' to={'/post/' + id}>
            <div className='article-image'>
                <img src={poster} alt=''/>
            </div>
            <div className='article-content'>
                <div className='article-title'>{title}</div>
                <div className='article-description'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae...</div>
